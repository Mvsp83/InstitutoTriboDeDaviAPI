...
namespace InstitutoTriboDeDavi.API
{
    public class Startup : IStartup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IConfiguracaoLojaService, ConfiguracaoLojaService>();
            ...
            services.AddScoped<ICompeticaoEventoRepository, CompeticaoEventoRepository>();
            services.AddScoped<ICompeticaoEventoService, CompeticaoEventoService>();
            ...
            services.AddSingleton<IMapper>(sp =>
            {
                var config = new MapperConfiguration(cfg =>
                {
                    ...
                    cfg.CreateMap<ConfiguracaoLoja, ConfiguracaoLojaDTO>().ReverseMap();
                    ...
                    cfg.CreateMap<Atleta, AtletaDTO>().ReverseMap();
                    cfg.CreateMap<AvaliacaoFisica, AvaliacaoFisicaDTO>().ReverseMap();
                    cfg.CreateMap<IndicadorAvaliacao, IndicadorAvaliacaoDTO>().ReverseMap();
                    ...
                    cfg.CreateMap<CompeticaoEvento, CompeticaoEventoDTO>().ReverseMap();
                    cfg.CreateMap<ParticipacaoAtleta, ParticipacaoAtletaDTO>().ReverseMap();
